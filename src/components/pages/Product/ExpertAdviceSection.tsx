...
export default function ExpertAdviceSection() {
    return (
        <section className="container mx-auto px-4 py-8 lg:py-12">
            <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 overflow-hidden">
                {/* Content Side */}
                <div className="p-6 lg:p-16 flex flex-col justify-center space-y-6">
                    <div>
                ...
                {/* Image Side */}
                <div className="relative min-h-[300px] lg:h-auto flex items-center justify-center overflow-hidden rounded-2xl lg:rounded-none">
                    <Image
                        src="/img/imgi_85.png"
                        alt="Expert Advice"
